        ...
        <div id="total">
            <div id="contenido">
                <div id="cabeceraCuerpo">
                    <div class="titulo"><img id="tituloManga" src="../img/mangaTitulo.jpg"/></div>
                </div>
                <hr/>
                <div class="productos" id="productos">
                    <table width="100%" height="100%" border="0" align="center">
                        ...
                        ?>
                                <td>
                                    <a href="detalles_menu.php?id_producto=<?php echo $row_listado['id_producto']; ?>"><img class="imageField" src="../imagenes/mangas/<?php echo $row_listado['imagen']; ?>" width="200" height="200"/></a>
                                    <h3><?php echo $row_listado['nombre']; ?></h3>
                                    <p>$<?php echo $row_listado['precio']; ?><br/></p>
