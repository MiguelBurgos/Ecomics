        ...
        <div id="total">
            <div id="contenido">
                <table width="100%" height="100%">
                    <tr>
                        <th align="center" class="producto_titulo">
                            <p>
                                <?php echo $row_detalle_producto['nombre']; ?>
                            </p>
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center">
                            <p>
                                Precio Unitario: $<?php echo $row_detalle_producto['precio']; ?>
                            </p>
                    </tr>
                    <tr>
                        <td align="center">
                            <img src="../imagenes/productos/detalle/<?php echo $row_detalle_producto['imagen']; ?>" width="200" height="200"/>
                        </td>
                    </tr>
                    <tr align="center">
                        <td>
                            <form name="form1" method="post" action="../carrito/carritoMenu.php">
                                ...
                                <input name="nombre" type="hidden" id="nombre" value="<?php echo $row_detalle_producto['nombre']; ?>"/>
                                <input name="precio" type="hidden" id="precio" value="<?php echo $row_detalle_producto['precio']; ?>"/>
