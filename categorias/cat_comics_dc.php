        ...
        <div id="total">
            <div id="contenido">
                <div id="cabeceraCuerpo">
                    <div class="titulo"><img id="tituloManga" src="../img/dcTitulo.jpg"/></div>
                </div>
                <hr/>
                    ...
                    <table width="100%" height="100%" border="0" align="center">
                        <?php
                            ...
                            do {
                                ...
                                ?>
                                <td>
                                    <a href="detalles_menu.php?id_producto=<?php echo $row_listado['id_producto']; ?>"><img class="imageField" src="../imagenes/Dc/<?php echo $row_listado['imagen']; ?>" width="200" height="200"/></a>
