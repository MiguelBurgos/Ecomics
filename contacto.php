...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="contactenos">
        Cont&aacute;ctenos, ser&aacute; un placer atenderle
        </div>

        <form id="formulario">
            <input name="nombre" type="text" class="feedback-input" placeholder="Nombre" />
            <input name="correo" type="text" class="feedback-input" placeholder="Email" />
            <textarea name="mensaje" class="feedback-input" placeholder="Comentario" ></textarea>
            <input id="enviar" type="submit" value="Enviar"  id="enviar"/>
        </form>
