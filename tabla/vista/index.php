        ...
        <div id="total">
            <div id="contenido">
                ...
                <div class="contacto_caja" style="clear:both;">
                    ...
                    <form action="../control/controlador.php" method="post" enctype="multipart/form-data" id="formulario">
                        <label>Categor&iacute;a</label>
                        <select name="id_cat" id="id_cat" value="" required="required">
                        ...
                        <label>Precio</label>
                        <input type="text" value="" name="precio" id="precio" required="required" /><br /><br/>
                        <label>Imagen</label>
